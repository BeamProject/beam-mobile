...
import '../../features/data/beam/inject/beam_module.dart' as _i62;
import '../../features/data/beam/testing/test_beam_module.dart' as _i58;
...
import '../../features/data/inject/repository_module.dart' as _i61;
...
import '../../features/data/local/storage_module.dart' as _i56;
import '../../features/data/local/testing/fake_storage.dart' as _i55;
import '../../features/data/local/testing/test_storage_module.dart' as _i57;
import '../../features/data/local/user_storage.dart' as _i20;
import '../../features/data/payment_repository_impl.dart' as _i39;
import '../../features/data/pedometer/pedometer_module.dart' as _i63;
import '../../features/data/pedometer/pedometer_service.dart' as _i49;
import '../../features/data/pedometer/step_tracker.dart' as _i44;
import '../../features/data/profile_repository_impl.dart' as _i11;
...
import '../../features/domain/repositories/profile_repository.dart' as _i42;
...
import '../../features/domain/usecases/get_daily_step_count_goal.dart' as _i47;
...
import '../../features/domain/usecases/get_last_step_count_measurement.dart'
    as _i33;
import '../../features/domain/usecases/get_monthly_donation_goal.dart' as _i48;
...
import '../../features/domain/usecases/observe_step_count.dart' as _i52;
...
import '../../features/presentation/profile/model/profile_model.dart' as _i53;
import '../../features/presentation/settings/settings_model.dart' as _i54;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i11.ProfileRepositoryImpl>(() => _i11.ProfileRepositoryImpl());
  ...
  gh.factory<_i42.ProfileRepository>(
      () => dataRepositoryModule
          .profileRepository(get<_i11.ProfileRepositoryImpl>()),
      registerFor: {_prod});
  ...
  gh.factory<_i47.GetDailyStepCountGoal>(
      () => _i47.GetDailyStepCountGoal(get<_i42.ProfileRepository>()));
  gh.factory<_i48.GetMonthlyDonationGoal>(
      () => _i48.GetMonthlyDonationGoal(get<_i42.ProfileRepository>()));
  gh.factory<_i5.PaymentRepository>(
      () => dataRepositoryModule
  ...
  gh.factory<_i9.PaymentsRemoteDataSource>(
      ...
      registerFor: {_prod});
  gh.lazySingleton<_i49.PedometerService>(() => _i49.PedometerService(
      get<_i43.SettingsLocalDataSource>(),
      get<_i18.UpdateLastStepCountMeasurement>()));
  gh.factory<_i50.StepCounterService>(
      () => pedometerModule.stepCounterService(get<_i49.PedometerService>()),
      registerFor: {_prod});
  gh.factory<_i51.StepCounterServiceInteractor>(
      () => _i51.StepCounterServiceInteractor(get<_i50.StepCounterService>()));
  gh.factory<_i52.ObserveStepCount>(() => _i52.ObserveStepCount(
      get<_i50.StepCounterService>(), get<_i16.StepsRepository>()));
  gh.factory<_i53.ProfileModel>(() => _i53.ProfileModel(
      get<_i38.ObserveUser>(),
      get<_i52.ObserveStepCount>(),
      get<_i40.PaymentsInteractor>(),
      get<_i48.GetMonthlyDonationGoal>(),
      get<_i32.GetDailyStepCountRange>(),
      get<_i47.GetDailyStepCountGoal>()));
  gh.factory<_i54.SettingsModel>(
      () => _i54.SettingsModel(get<_i51.StepCounterServiceInteractor>()));
  gh.singleton<_i55.FakeStorage>(_i55.FakeStorage());
  gh.singleton<_i23.FakeUserRepository>(_i23.FakeUserRepository());
  gh.singleton<_i4.FlutterSecureStorage>(
      fakeStorageModule.flutterSecureStorage(get<_i55.FakeStorage>()),
      registerFor: {_test});
...
class _$FakeStorageModule extends _i57.FakeStorageModule {}

class _$TestBeamModule extends _i58.TestBeamModule {
  @override
  _i28.MockBeamService get mockBeamService => _i28.MockBeamService();
}

class _$RepositoryModule extends _i59.RepositoryModule {
  @override
  _i6.MockPaymentRepository get mockPaymentRepository =>
      _i6.MockPaymentRepository();
}

class _$DataSourcesModule extends _i60.DataSourcesModule {
  @override
...
class _$DataRepositoryModule extends _i61.DataRepositoryModule {}

class _$BeamModule extends _i62.BeamModule {}

class _$PedometerModule extends _i63.PedometerModule {}
