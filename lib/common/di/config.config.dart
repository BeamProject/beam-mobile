...
import '../../features/data/beam/inject/beam_module.dart' as _i63;
import '../../features/data/beam/testing/test_beam_module.dart' as _i59;
...
import '../../features/data/inject/repository_module.dart' as _i62;
...
import '../../features/data/local/storage_module.dart' as _i57;
import '../../features/data/local/testing/fake_storage.dart' as _i56;
...
import '../../features/data/pedometer/pedometer_module.dart' as _i64;
...
import '../../features/domain/usecases/profile_interactor.dart' as _i53;
...
import '../../features/presentation/profile/model/profile_model.dart' as _i54;
import '../../features/presentation/settings/settings_model.dart' as _i55;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i53.ProfileInteractor>(
      () => _i53.ProfileInteractor(get<_i48.ProfileRepository>()));
  gh.factory<_i54.ProfileModel>(() => _i54.ProfileModel(
      get<_i38.ObserveUser>(),
      get<_i52.ObserveStepCount>(),
      get<_i40.PaymentsInteractor>(),
      get<_i53.ProfileInteractor>(),
      get<_i32.GetDailyStepCountRange>()));
  gh.factory<_i55.SettingsModel>(() => _i55.SettingsModel(
      get<_i51.StepCounterServiceInteractor>(), get<_i53.ProfileInteractor>()));
  gh.singleton<_i56.FakeStorage>(_i56.FakeStorage());
  gh.singleton<_i23.FakeUserRepository>(_i23.FakeUserRepository());
  gh.singleton<_i4.FlutterSecureStorage>(
      fakeStorageModule.flutterSecureStorage(get<_i56.FakeStorage>()),
      registerFor: {_test});
...
class _$StorageModule extends _i57.StorageModule {}

class _$FakeStorageModule extends _i58.FakeStorageModule {}

class _$TestBeamModule extends _i59.TestBeamModule {
  @override
  _i28.MockBeamService get mockBeamService => _i28.MockBeamService();
}

class _$RepositoryModule extends _i60.RepositoryModule {
  @override
  _i6.MockPaymentRepository get mockPaymentRepository =>
      _i6.MockPaymentRepository();
}

class _$DataSourcesModule extends _i61.DataSourcesModule {
  @override
...
class _$DataRepositoryModule extends _i62.DataRepositoryModule {}

class _$BeamModule extends _i63.BeamModule {}

class _$PedometerModule extends _i64.PedometerModule {}
